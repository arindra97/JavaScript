...
const frontEndDeveloper = createFrontEndDeveloper('arindraFE');
...
const backEndDeveloper = createBackEndDeveloper('');
...
const devOpsDeveloper = createDevOps('rikoBE');
...
const fullStackDeveloper = createFullStackDeveloper('arindraRikoFD');
